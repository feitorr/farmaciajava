public class farmaceutico extends utilizador {
    ...
    public farmaceutico(String login, String password, String nome, boolean estado, String email, String tipo, String nif, String morada, String contactoTelefonico) {
